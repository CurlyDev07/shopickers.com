        ...
        <div class="tflex tjustify-between">
            ...
            <div class="tself-center trelative thidden sm:tblock">
                <a href="{{ route('cart') }}" id="cart" class="btn-floating hover:tbg-white tbg-white">
                    <i class="material-icons" style="color: #2d7bbf;">shopping_cart</i>
                </a>
...
{{-- MOBILE NAV --}}
<div class="sm:thidden tpy-1 tbg-primary tborder-t tbottom-0 tfixed tflex titems-center tw-full" style="z-index: 999;">
    ...
    <a href="{{ route('cart') }}" class="tleading-tight tp-1 ttext-center waves-effect tw-1/4 trelative">
        ...
        <span class="cart_item_count t-mt-8 tabsolute tbg-red-500 tml-2 trounded-full ttext-white" 
