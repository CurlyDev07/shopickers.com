            ...
            <div id="banner_container">
                <div class="tmb-3">
                    <div class="tflex tflex-wrap tw-full tmb-4 trelative">
                        <input type="text"  placeholder="https://example.com/products/black-tea" class="browser-default tw-1/3 tflex titems-center tleading-normal tbg-grey-lighter trounded trounded-r-none tborder tborder-r-0 tborder-grey-light tpx-3 twhitespace-no-wrap ttext-grey-dark ttext-sm">
                        <input type="file" class="banner_input browser-default tw-1/3 tborder tborder-grey-light tflex-1 tflex-auto tflex-grow tflex-shrink th-10 tleading-normal tpx-3 tpy-1 trelative tw-px">
                        <input type="text"  placeholder="Alt" class="browser-default tbg-grey-lighter tborder tborder-grey-light tborder-l-0 tflex titems-center tleading-normal tpx-3 ttext-grey-dark ttext-sm tw-1/3 twhitespace-no-wrap">
