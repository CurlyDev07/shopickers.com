...
@section('content')
    ...
    <h1 class="tfont-medium tmb-4 tmt-2 ttext-blue-500 ttext-xl">LOGIN OR CREATE AN ACCOUNT</h1>

    <div class="tflex tflex-col md:tflex-row md:tp-8 tpx-5 tpy-8  tmb-10 tborder" style="border-top: 4px solid #4299e1;">
