...
@section('content')
    <h1 class="ttext-blue-500 ttext-xl tfont-medium tmb-6">CONTACT US</h1>

    <div class="tflex tflex-col lg:tflex-row">
                ...
                <form action="javascript:void(0)" class="">
                    ...
                    <div class="row tpr-5">
                        ...
                        <div class="col s12 ttext-right">
                            <div class="tpr-3">
                                <button class="focus:tbg-blue-500 tbg-blue-500 tpx-5 tpy-1 ttext-white waves-effect waves-light">Submit</button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="tw-5/5 lg:tw-2/5 lg:tborder-0 lg:tmt-0 lg:tpt-0 tborder-t tmt-3 tpt-8">
            ...
            <div class="tflex titems-center tmb-4">
                <div class="tbg-blue-500 tpx-4 tpy-3 tmr-4">
            ...
            <div class="tflex titems-center tmb-4">
                <div class="tbg-blue-500 tpx-3 tpy-3 tmr-4">
            ...
            <div class="tflex titems-center tmb-4">
                ...
                <div class="tflex tflex-col">
                    <a href="https://web.facebook.com/shopshippers/" class="hover:tunderline ttext-blue-500">https://facebook.com/shopshippers</a>
                    <a href="https://web.facebook.com/shopshippers/" class="hover:tunderline ttext-blue-500">@shopshippers</a>
                </div>
            </div>
        </div><!-- RIGHT -->
    </div>
