...
<div class="tflex tflex-wrap tmb-5">
    <div class="tw-1/4 tpr-8">
        <ul class="tborder tborder-gray-400" style="height: 398px;">
            <li class="tpx-6 tpy-3 ttext-sm tborder-b tfont-bold tbg-gray-200 ttext-gray-800">CATEGORIES</li>
            <li class="ttext-gray-9 hover:tbg-blue-500 hover:ttext-white">
            ...
            <li class="ttext-gray-900 hover:tbg-blue-500 hover:ttext-white">
                <a href="" class="tmx-8 tpy-4 tborder-b tblock ttext-sm tfont-medium hover:tborder-blue-500">Products</a>
            </li>
            <li class="ttext-gray-900 hover:tbg-blue-500 hover:ttext-white">
...
<div class="tflex tflex-column tmb-5">
    <div class="tw-1/4  tpr-8">
        <div class="side_promo-banner owl-carousel owl-theme trelative tborder">
            <div class="item">
        ...
        <div class="testimonial_side owl-carousel owl-theme tmt-5">
            <div class="item">
